$(document).ready(function () {
    ...
    $('.valueShowHideBtn').click(function () {
        targetId = $(this);
        if (targetId.closest('.valueShowHide').find('input').attr('type') == 'password') {
            targetId.closest('.valueShowHide').find('input').attr('type', 'text')
            targetId.find('i').attr('class', 'ri-eye-fill align-middle')
        } else {
            targetId.closest('.valueShowHide').find('input').attr('type', 'password')
            targetId.find('i').attr('class', 'ri-eye-off-fill align-middle')
        }
    })

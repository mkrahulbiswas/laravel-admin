...
function initCallOnModalClose() {
    $('.con-add-modal, .con-edit-modal, .con-access-modal').on("hidden.bs.modal", function () {
        ...
        let ids = '#saveBroadTypeForm, #updateBroadTypeForm, #saveLogoForm, #updateLogoForm, #saveNavTypeForm, #updateNavTypeForm, #saveNavMainForm, #updateNavMainForm, #saveNavSubForm, #updateNavSubForm, #saveNavNestedForm, #updateNavNestedForm, #savePropertyAttributesForm, #updatePropertyAttributesForm, #savePropertyTypesForm, #updatePropertyTypesForm';

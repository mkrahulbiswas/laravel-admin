! function () {
    ...
    function u() {
        feather.replace();
        var e, t, a = "/" == location.href ? "/" : location.href;
        var j = "/" == location.href ? "/" : location.href;

        (a = a.substring(a.lastIndexOf("/") + 1)) &&
        ("twocolumn-panel" == document.body.className &&
            document.getElementById("two-column-menu").querySelector('[href="' + j + '"]').classList.add("active"),
            (a = document.getElementById("navbar-nav").querySelector('[href="' + j + '"]')) ?
    ...
    function g() {
        var e = "/" == location.href ? "/" : location.href;
        var j = "/" == location.href ? "/" : location.href;

        (e = e.substring(e.lastIndexOf("/") + 1)) &&
        (e = document.getElementById("navbar-nav").querySelector('[href="' + j + '"]')) &&

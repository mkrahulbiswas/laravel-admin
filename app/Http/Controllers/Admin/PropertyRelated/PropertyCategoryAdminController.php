    ...
    public function saveManageCategory(Request $request)
    {
        try {
            ...
            if ($validator->fails()) {
                ...
                $manageCategory->uniqueId = $this->generateYourChoice([['preString' => 'PRMC', 'length' => 6, 'model' => ManageCategory::class, 'field' => '', 'type' => Config::get('constants.generateType.uniqueId')]]);
        ...
        try {
            ...
            if ($validator->fails()) {
                ...
                if (AssignCategory::where([
                    ...
                    $assignCategory->uniqueId = $this->generateYourChoice([['preString' => 'PRAC', 'length' => 6, 'model' => AssignCategory::class, 'field' => '', 'type' => Config::get('constants.generateType.uniqueId')]]);

...
@section('content')
                ...
                <div class="mb-3 mb-sm-0">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Type Of Floorings</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 tdContentMain">
                            <div class="tdContentSub">
                                <table id="propertyRelated-propertyAttributes-typeOfFloorings" class="table table-bordered dt-responsive nowrap table-striped align-middle" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Unique Id</th>
    ...
    <div id="con-add-modal" class="modal fade con-add-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="saveTypeOfFlooringsForm" action="{{ route('admin.save.typeOfFloorings') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['save']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="saveTypeOfFlooringsBtn">
    ...
    <div id="con-edit-modal" class="modal fade con-edit-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="updateTypeOfFlooringsForm" action="{{ route('admin.update.typeOfFloorings') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['update']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="updateTypeOfFlooringsBtn">
                                <i class="las la-save label-icon align-middle fs-16 me-2"></i>
                                <span>Update</span>
                            </button>
                        @endif

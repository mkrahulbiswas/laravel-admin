...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12 tdContentMain">
                            <div class="tdContentSub">
                                <table id="propertyRelated-propertyAttributes-propertyFeatures" class="table table-bordered dt-responsive nowrap table-striped align-middle" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Unique Id</th>
    ...
    <div id="con-add-modal" class="modal fade con-add-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="savePropertyFeaturesForm" action="{{ route('admin.save.propertyFeatures') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['save']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="savePropertyFeaturesBtn">
    ...
    <div id="con-edit-modal" class="modal fade con-edit-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="updatePropertyFeaturesForm" action="{{ route('admin.update.propertyFeatures') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['update']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="updatePropertyFeaturesBtn">
                                <i class="las la-save label-icon align-middle fs-16 me-2"></i>
                                <span>Update</span>
                            </button>
                        @endif

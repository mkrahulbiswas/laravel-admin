            ...
            <div class="card-header cardHeader">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div class="mb-3 mb-sm-0">
                        ...
                        <span class="text-muted">From this section you can manage <b>main category</b> list data</span>
                    </div>
                    <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="tdFilterForm p-3">
                                        <form id="filterManageCategoryForm" method="POST" action="{{ route('admin.get.manageCategory') }}" class="filterManageCategoryForm" data-type="{{ Config::get('constants.status.category.main') }}">
                                            @csrf
                                            <div class="row gap-2">
                    ...
                    <div class="col-md-12 tdContentMain">
                        <div class="tdContentSub">
                            <table id="propertyRelated-propertyCategory-manageCategory-main" class="propertyRelated-propertyCategory-manageCategory table table-bordered dt-responsive nowrap table-striped align-middle" cellspacing="0" width="100%" data-type="{{ Config::get('constants.status.category.main') }}">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Unique Id</th>

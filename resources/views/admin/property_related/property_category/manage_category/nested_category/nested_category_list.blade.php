                ...
                <div class="row">
                                    ...
                                    <div class="tdFilterForm p-3">
                                        <form id="filterNestedCategoryForm" method="POST" action="{{ route('admin.get.manageCategory') }}" class="m-b-20">
                                            ...
                                            <div class="row gap-2">
                                                ...
                                                <div class="form-element col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-2">
                                                    <div class="form-icon set-validation">
                                                        <select name="subCategory" id="subCategoryFilter" class="selectTwo select2-subCategory subCategoryDDD">
                    ...
                    <div class="col-md-12 tdContentMain">
                        <div class="tdContentSub">
                            <table id="propertyRelated-propertyCategory-manageCategory-nested" class="propertyRelated-propertyCategory-manageCategory table table-bordered dt-responsive nowrap table-striped align-middle" cellspacing="0" width="100%" data-type="{{ Config::get('constants.status.category.nested') }}">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Unique Id</th>

...
@section('content')
                ...
                <div class="mb-3 mb-sm-0">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Assign Broad</li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="row main-page-content">
        <div class="col-lg-12">
            <div class="card">
                @if ($data['propertyType'] != [] && $data['broadType'] != [])
                                                ...
                                                <div class="alert-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <p class="mb-0">There is a problem that is we did not found any <b>property type</b>. For manage <b>assign broad</b> section you must entry <b>property type</b> first.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="alert-content">
                                                    <p class="mb-0">To add broad type <a class="btn btn-sm btn-success" href="{{ route('admin.show.propertyType') }}">click me</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="alert alert-primary alert-dismissible alert-additional fade show mb-0" role="alert">
                                                <div class="alert-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="alert-heading">Note!</h5>
                                                            <p class="mb-0">There is a problem that is we did not found any <b>broad type</b>. For manage <b>assign broad</b> section you must entry <b>broad type</b> first.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="alert-content">
                                                    <p class="mb-0">To add broad type <a class="btn btn-sm btn-success" href="{{ route('admin.show.broadType') }}">click me</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="tdFilterForm p-3">
                                                <form id="filterAssignBroadForm" method="POST" action="{{ route('admin.get.assignBroad') }}" class="m-b-20">
                                                    @csrf
                                                    <div class="row gap-2">
                                                        ...
                                                        <div class="form-element col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-2">
                                                            <div class="form-icon set-validation">
                                                                <select class="selectTwo form-control form-control-icon select2-broadType" name="broadType" id="broadTypeFilter">
                                                                    <option value="">Select broad type</option>
                                                                    @foreach ($data['broadType'] as $key)
                                                                        <option value="{{ $key['id'] }}">{{ $key['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <i class="mdi mdi-list-status"></i>
                                                        ...
                                                        <div class="form-element col-sm-12 col-md-6 col-lg-5 col-xl-4 col-xxl-3">
                                                            <div class="form-group d-flex flex-row justify-content-start">
                                                                @if ($permission['search']['permission'] == true)
                                                                    <button type="button" class="btn btn-info btn-label waves-effect waves-light filterAssignBroadBtn" title="Search">
                                                                        <i class="mdi mdi-briefcase-search-outline label-icon align-middle fs-16 me-2"></i>
                                                                        <span>Search</span>
                                                                    </button>
                                                                @endif
                                                                @if ($permission['reset']['permission'] == true)
                                                                    <button type="button" class="btn btn-danger btn-label waves-effect waves-light filterAssignBroadBtn ms-2" title="Reload">
                            ...
                            <div class="col-md-12 mb-4 no_noteMain">
                                <div class="no_noteSub bg-light">
                                    <p class="no_noteHeading p-3 bg-warning-subtle">
                                        ...
                                        <span class="no_noteText p-2 bg-warning"><b>Property type list</b></span>
                                        <span class="no_noteText p-2 bg-warning"><b>Broad type list</b></span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-12 tdContentMain">
                                <div class="tdContentSub">
                                    <table id="propertyRelated-manageBroad-assignBroad" class="table table-bordered dt-responsive nowrap table-striped align-middle" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Unique Id</th>
    ...
    <div id="con-add-modal" class="modal fade con-add-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="saveAssignBroadForm" action="{{ route('admin.save.assignBroad') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Add Assign Broad</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-element col-sm-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                ...
                                <div class="form-icon set-validation">
                                    <select class="selectTwo form-control form-control-icon select2-propertyType-addModal" name="propertyType" id="propertyType">
                                        <option value="">Select property type</option>
                                        @foreach ($data['propertyType'] as $key)
                                            <option value="{{ $key['id'] }}">{{ $key['name'] }}</option>
                                        @endforeach
                            ...
                            <div class="form-element col-sm-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                <label for="name" class="form-label">Broad Type <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select class="selectTwo form-control form-control-icon select2-broadType-addModal" name="broadType" id="broadType">
                                        <option value="">Select broad type</option>
                                        @foreach ($data['broadType'] as $key)
                                            <option value="{{ $key['id'] }}">{{ $key['name'] }}</option>
                                        @endforeach
                                ...
                                <div class="validation-error" id="broadTypeErr"></div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['save']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="saveAssignBroadBtn">
    ...
    <div id="con-edit-modal" class="modal fade con-edit-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="updateAssignBroadForm" action="{{ route('admin.update.assignBroad') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    <input type="hidden" name="id" id="id" value="">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Edit Assign Broad</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-element col-sm-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                <label for="name" class="form-label">Property Type <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select class="selectTwo form-control form-control-icon select2-propertyType-editModal" name="propertyType" id="propertyType2">
                                        <option value="">Select property type</option>
                                        @foreach ($data['propertyType'] as $key)
                            ...
                            <div class="form-element col-sm-12 col-md-6 col-xl-6 col-lg-6 mb-3">
                                <label for="name" class="form-label">Broad Type <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select class="selectTwo form-control form-control-icon select2-broadType-editModal" name="broadType" id="broadType2">
                                        <option value="">Select broad type</option>
                                        @foreach ($data['broadType'] as $key)
                                            <option value="{{ $key['id'] }}" data-name="{{ $key['name'] }}">{{ $key['name'] }}</option>
                                        @endforeach
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['update']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="updateAssignBroadBtn">
                                <i class="las la-save label-icon align-middle fs-16 me-2"></i>
                                <span>Update</span>
                            </button>
                        @endif
    ...
    <div id="con-info-modal" class="modal fade con-info-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Details Assign Broad</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-xl-6 col-lg-6">
                            <div class="d-flex mb-4 each-detail-box">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <span class="detail-span d-block mb-0" id="broadType"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">

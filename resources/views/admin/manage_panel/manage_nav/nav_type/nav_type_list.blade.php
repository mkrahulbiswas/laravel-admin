...
@section('content')
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <button type="button" class="btn btn-success btn-label waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target="#con-add-modal"><i
                                    class="las la-plus-circle label-icon align-middle fs-16 me-2"></i> Add Nav Type</button>
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="filter-table-form p-3">
                                            <form id="filterNavTypeForm" method="POST"
                                                action="{{ route('admin.get.navType') }}" class="m-b-20">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 m-t-5">
                                                        <div class="form-group d-flex flex-row justify-content-around">
                                                            <button type="button"
                                                                class="btn btn-info btn-label waves-effect waves-light filterNavTypeBtn"
                                                                title="Search"><i
                                                                    class="mdi mdi-briefcase-search-outline label-icon align-middle fs-16 me-2"></i>
                                                                Search</button>
                                                            <button type="button"
                                                                class="btn btn-danger btn-label waves-effect waves-light filterNavTypeBtn"
                                                                title="Reload"><i
                        ...
                        <div class="col-md-12 table-data-main">
                            <div class="table-data">
                                <table id="managePanel-manageNav-navType"
    ...
    <div id="con-add-modal" class="modal fade con-add-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="saveNavTypeForm" action="{{ route('admin.save.navType') }}" method="POST"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-label waves-effect waves-light"
                            id="saveNavTypeBtn"><i class="las la-save label-icon align-middle fs-16 me-2"></i>
    ...
    <div id="con-edit-modal" class="modal fade con-edit-modal con-common-modal" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="updateNavTypeForm" action="{{ route('admin.update.navType') }}" method="POST"
                    enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-label waves-effect waves-light"
                            ...
                            Close</button>
                        <button type="submit" class="btn btn-primary btn-label waves-effect waves-light"
                            id="updateNavTypeBtn"><i class="las la-save label-icon align-middle fs-16 me-2"></i>

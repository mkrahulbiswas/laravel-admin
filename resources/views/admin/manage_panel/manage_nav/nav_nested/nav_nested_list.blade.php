        ...
        <div class="card">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <button type="button" class="btn btn-success btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#con-add-modal"><i class="las la-plus-circle label-icon align-middle fs-16 me-2"></i> Add Nav Nested</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="modal-content">
            <form id="saveNavNestedForm" action="{{ route('admin.save.navNested') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="saveNavNestedBtn"><i class="las la-save label-icon align-middle fs-16 me-2"></i> <span>Save</span></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="updateNavNestedForm" action="{{ route('admin.update.navNested') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-label waves-effect waves-light" data-bs-dismiss="modal"><i class="las la-window-close label-icon align-middle fs-16 me-2"></i> Close</button>
                    <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="updateNavNestedBtn"><i class="las la-save label-icon align-middle fs-16 me-2"></i> <span>Update</span></button>
                </div>
            </form>
        </div>
    </div>

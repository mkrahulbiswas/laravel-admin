        ...
        <div class="card">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <button type="button" class="btn btn-success btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#con-add-modal"><i class="las la-plus-circle label-icon align-middle fs-16 me-2"></i> Add Nav Sub</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 m-t-5">
                                                    <div class="form-group d-flex flex-row justify-content-around">
                                                        <button type="button" class="btn btn-info btn-label waves-effect waves-light filterNavSubBtn" title="Search"><i class="mdi mdi-briefcase-search-outline label-icon align-middle fs-16 me-2"></i> Search</button>
                                                        <button type="button" class="btn btn-danger btn-label waves-effect waves-light filterNavSubBtn" title="Reload"><i class="bx bx-reset label-icon align-middle fs-16 me-2"></i> Reset</button>
                                                    </div>
                                                </div>
        ...
        <div class="modal-content">
            <form id="saveNavSubForm" action="{{ route('admin.save.navSub') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="saveNavSubBtn"><i class="las la-save label-icon align-middle fs-16 me-2"></i> <span>Save</span></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="updateNavSubForm" action="{{ route('admin.update.navSub') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-label waves-effect waves-light" data-bs-dismiss="modal"><i class="las la-window-close label-icon align-middle fs-16 me-2"></i> Close</button>
                    <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="updateNavSubBtn"><i class="las la-save label-icon align-middle fs-16 me-2"></i> <span>Update</span></button>
                </div>
            </form>
        </div>
    </div>

...
@section('content')
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="tdFilterForm p-3">
                                            <form id="filterNestedNavForm" method="POST" action="{{ route('admin.get.nestedNav') }}" class="m-b-20">
                                                @csrf
                                                <div class="row gap-2">
                                                    ...
                                                    <div class="form-element col-sm-12 col-md-6 col-lg-5 col-xl-4 col-xxl-3">
                                                        <div class="form-group d-flex flex-row justify-content-start">
                                                            @if ($permission['search']['permission'] == true)
                                                                <button type="button" class="btn btn-info btn-label waves-effect waves-light filterNestedNavBtn" title="Search">
                                                                    <i class="mdi mdi-briefcase-search-outline label-icon align-middle fs-16 me-2"></i>
                                                                    <span>Search</span>
                                                                </button>
                                                            @endif
                                                            @if ($permission['reset']['permission'] == true)
                                                                <button type="button" class="btn btn-danger btn-label waves-effect waves-light filterNestedNavBtn ms-2" title="Reload">
                        ...
                        <div class="col-md-12 tdContentMain">
                            <div class="tdContentSub">
                                <table id="adminRelated-navigationAccess-manageSideNav-nestedNav" class="table table-bordered dt-responsive nowrap table-striped align-middle" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Unique Id</th>
                ...
                <form id="saveNestedNavForm" action="{{ route('admin.save.nestedNav') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-element col-12 mb-3">
                                ...
                                <div class="form-icon set-validation">
                                    <select name="mainNav" id="mainNav" class="selectTwo select2-mainNav-addModal mainNavDDD" data-action="{{ route('admin.get.subNavDDD') }}"></select>
                                    <i class="bx bx-bar-chart-square"></i>
                                </div>
                                <div class="validation-error" id="mainNavErr"></div>
                            </div>
                            <div class="form-element col-12 mb-3">
                                <label for="subNav" class="form-label">Sub Nav <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select name="subNav" id="subNav" class="selectTwo select2-subNav-addModal subNavDDD"></select>
                                    <i class="bx bx-list-ul"></i>
                                </div>
                                <div class="validation-error" id="subNavErr"></div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['save']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="saveNestedNavBtn">
    ...
    <div id="con-edit-modal" class="modal fade con-edit-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="updateNestedNavForm" action="{{ route('admin.update.nestedNav') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-element col-12 mb-3">
                                <label for="mainNav" class="form-label">Main Nav <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select name="mainNav" id="mainNav2" class="selectTwo select2-mainNav-editModal mainNavDDD" data-action="{{ route('admin.get.subNavDDD') }}"></select>
                                    <i class="bx bx-bar-chart-square"></i>
                                </div>
                                <div class="validation-error" id="mainNavErr"></div>
                            </div>
                            <div class="form-element col-12 mb-3">
                                <label for="subNav" class="form-label">Sub Nav <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select name="subNav" id="subNav2" class="selectTwo select2-subNav-editModal subNavDDD"></select>
                                    <i class="bx bx-list-ul"></i>
                                </div>
                                <div class="validation-error" id="subNavErr"></div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['update']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="updateNestedNavBtn">
                                <i class="las la-save label-icon align-middle fs-16 me-2"></i>
                                <span>Update</span>
                            </button>
                        @endif
    ...
    <div id="con-access-modal" class="modal fade con-access-modal con-common-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="accessNestedNavForm" action="{{ route('admin.access.nestedNav') }}" method="POST" enctype="multipart/form-data" novalidate class="common-form">
                    @csrf
                    <input type="hidden" name="id" id="id" value="">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($permission['set']['permission'] == true)
                            <button type="submit" class="btn btn-primary btn-label waves-effect waves-light" id="accessNestedNavBtn">
                                <i class="las la-save label-icon align-middle fs-16 me-2"></i>
                        ...
                        <div class="col-sm-6 col-md-6 col-xl-6 col-lg-6">
                            <div class="d-flex mb-4 each-detail-box">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <span class="detail-span d-block mb-0" id="subNav"></span>
                                </div>
                            </div>
                        </div>

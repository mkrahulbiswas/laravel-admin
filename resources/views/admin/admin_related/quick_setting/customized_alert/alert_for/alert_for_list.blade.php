                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-element col-12 mb-3">
                                ...
                                <div class="form-icon set-validation">
                                    <select name="alertType" id="alertType" class="selectPicker form-control" data-style="btn-light" title="Select alert type">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-element col-12 mb-3">
                                <label for="alertType" class="form-label">Alert type <span class="text-danger">{{ __('messages.requiredFiend') }}</span></label>
                                <div class="form-icon set-validation">
                                    <select name="alertType" id="alertType2" class="selectPicker form-control" data-style="btn-light" title="Select alert type">
                                        <option value="">Select alert type</option>
                                        @foreach ($data['alertType'] as $item)
